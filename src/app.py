                ...
                with vuetify3.VCol(cols=5, classes="pl-2"):
                    ...
                    with vuetify3.VWindow(v_model=("top_section", "main")):
                        ...
                        with vuetify3.VWindowItem(value="main"):
                            ...
                            with vuetify3.VWindow(
                                v_model=("selected_info_tab",)
                            ):
                                ...
                                with vuetify3.VWindowItem(value="compare"):
                                    with vuetify3.VCard(
                                        ...
                                        ctrl.update_mini_chart = (
                                            mini_chart_view.update
                                        )
                        ...
                        with vuetify3.VWindowItem(value="compare"):
                            with vuetify3.VCard(
                                ...
                                ctrl.update_compare_chart = (
                                    comparison_view.update
                                )
                        # ====================================================
                        ...
                        with vuetify3.VWindowItem(value="clusters"):
                            with vuetify3.VCard(
                                ...
                                html.Div("County Clustering (K-Means)", classes="text-h6 mb-2")
